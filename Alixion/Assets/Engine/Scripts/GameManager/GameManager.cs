...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (null == m_instance)
        {
            ...
            dialogs[1].Add("교황님한테서 고해성사를 하고 왔어...\n너무 멋진 분이시더라.");
            ...
            alienDatas.Add(new AlienData(ALIENTYPE.AT_ZEN, 
                ...
                "새로운 성인의 탄생이다!!\n< 그는 신이야... >",
                "Zen + Zen Ending",
                new ProfileData("착한짓!, 나눔, 의리, 행복.", "나쁜짓..., 못된짓, 거짓말.", "상쾌하고 항상 웃고 싶은 기분~"), dialogs));

            for (int i = 0; i < 3; ++i)
                dialogs[i].Clear();
            dialogs[0].Add("오늘 쓰레기통을 뒤져서 돈을 주웠어!!!\n하하하.");
            dialogs[0].Add("오늘은 돈벌기 딱 좋은 날씨네.");
            dialogs[0].Add("하하하!\n돈이 최고야 하하하!");
            ...
            dialogs[0].Add("세상엔 정말 멋진게 많아!\n하지만 아쉬운 것도...");
            dialogs[0].Add("나는 아마 멋진 사람이 될거야!");
            ...
            for (int i = 0; i < 3; ++i)
                dialogs[i].Clear();
            dialogs[0].Add("오늘 사람들 앞에서 쓰레기를 줍고왔어!\n많이 칭찬을 해주시더라구!");
            dialogs[0].Add("길에서 넘어져서 엎드려져있었는데\n사람들이 돈을주더라!!!\n완전 기분 좋았어!!!!");
            dialogs[0].Add("내 생각엔...\n돈이...좋은..걸까?");
            dialogs[1].Add("사람들을 많이 돕고 싶어!");
            dialogs[1].Add("오늘 길거리에서 쓰레기를 치웠는데,\n그걸 팔아서 돈을 벌었어! ");
            dialogs[1].Add("사람들을 많이 돕고도 싶지만\n그렇기 위해선 돈이 많이 필요할 거야!");
            ...
            dialogs[1].Add("몰래 성당에 잠입해서 미사를 보고왔어!\n교황님 멋지시더라...");
            ...
            alienDatas.Add(new AlienData(ALIENTYPE.AT_ZEN_SECLUSION, 
                ...
                new ProfileData("몰래 착한짓 하기, 사람들 몰래 산책하며 쓰레기 줍기, 교황님!", "사람들에게 모습 들키기.", "나는 착한게 좋아! 칭찬받지 않더라도!"), dialogs));

            for (int i = 0; i < 3; ++i)
                dialogs[i].Clear();
            dialogs[0].Add("나는 쓰레기를~\n열심히 치웠오~~");
            dialogs[0].Add("히히 나는 착한게 제일 좋아,\n하지만 악은 너무 싫어~");
            dialogs[0].Add("오늘은 어떤 착한일을 할까~~");
            ...
            dialogs[0].Add("나는 사람들 통수 치는게 재밌어.\n헤헤.");
            ...
            for (int i = 0; i < 3; ++i)
                dialogs[i].Clear();
            dialogs[0].Add("사람들에게 몰래 몰래 접근하고 있어!");
            dialogs[0].Add("오늘 몰래 쓰레기통을 부수고 왔어.\n너무 재밌어!");
            dialogs[0].Add("사람들 앞에 서는 건 좀 그래...");
            dialogs[1].Add("아침마다 쓰레기통을 몰래 부수고 다니니\n쓰레기가 너무 많아졌어.");
            dialogs[1].Add("사람들 몰래 움직이는 것에 익숙해졌어!\n그러다보니 좀더 과감해졌어!");
            dialogs[1].Add("몰래 몰래 파괴시키는 것은 없을까?");
            dialogs[2].Add("폭..탄 이라고 알아?");
            dialogs[2].Add("폭발은 너무 멋지더라!!!\n뻥이요~~!");
            dialogs[2].Add("몰래 몰래 설치하고 폭발시키고\n너무 재밌어!");
            alienDatas.Add(new AlienData(ALIENTYPE.AT_RUIN_SECLUSION, 
                ...
                new ProfileData("폭발, 파괴, 어둠.", "사람, 시선, 방어.", "몰래 펑! 터트리고싶당."), dialogs));
            ...
            alienDatas.Add(new AlienData(ALIENTYPE.AT_RUIN_MADNESS, 
                ...
                "Ruin + Madness Ending",
                new ProfileData("비웃음, 파괴, 살의.", "웃음, 희망, 미래.", "히히히 파.괘.조.아."), dialogs));
            ...
            alienDatas.Add(new AlienData(ALIENTYPE.AT_FRAUD_SECLUSION, 
                ...
                new ProfileData("그림자, 돈, 사기.", "내 뜻대로 안되는 것, 나서는 것.", "모든것은 내뜻대로 되면 좋겠어~"), dialogs));
            ...
            dialogs[1].Add("오늘 교황을 만나고 왔어?\n나도 그런것이 되고 싶당...");
            dialogs[1].Add("내가 다르게 태어난 이유는\n사람들위에 있기 위한게 아닐깡?");
            dialogs[1].Add("나는 신... 일수도\n있지 않을까?");
            ...
            alienDatas.Add(new AlienData(ALIENTYPE.AT_FRAUD_MADNESS, 
                ...
                new ProfileData("사기치기, 미친짓하기, 삥뜯기, 본인.", "행복해하기, 사랑.", "나는 위대해."), dialogs));
